...
struct tablepins { // Создали структуру с необходимым набором типов элиментов для PIN's.
	...
	uint32_t hal_pin;
	uint32_t gpio_name;
} tp[] = { "PA0", "A", 0, GPIO_PIN_0, GPIOA, "PA4", "A", 4, GPIO_PIN_4, GPIOA, "PA5", "A", 5, GPIO_PIN_5, GPIOA, "PA6", "A", 6, GPIO_PIN_6, GPIOA, "PA8", "A", 8, GPIO_PIN_8, GPIOA, "PA9", "A", 9, GPIO_PIN_9, GPIOA, "PA10", "A", 10, GPIO_PIN_10, GPIOA, "PA11", "A", 11, GPIO_PIN_11, GPIOA, "PA12",
		"A", 12, GPIO_PIN_12, GPIOA, "PA15", "A", 15, GPIO_PIN_15, GPIOA, "PB0", "B", 0, GPIO_PIN_0, GPIOB, "PB1", "B", 1, GPIO_PIN_1, GPIOB, "PB3", "B", 3, GPIO_PIN_3, GPIOB, "PB5", "B", 5, GPIO_PIN_5, GPIOB, "PB6", "B", 6, GPIO_PIN_6, GPIOB, "PB7", "B", 7, GPIO_PIN_7, GPIOB, "PB8", "B", 8,
		GPIO_PIN_8, GPIOB, "PB9", "B", 9, GPIO_PIN_9, GPIOB, "PB10", "B", 10, GPIO_PIN_10, GPIOB, "PB14", "B", 14, GPIO_PIN_14, GPIOB, "PB15", "B", 15, GPIO_PIN_15, GPIOB, "PC0", "C", 0, GPIO_PIN_0, GPIOC, "PC2", "C", 2, GPIO_PIN_2, GPIOC, "PC3", "C", 3, GPIO_PIN_3, GPIOC, "PC6", "C", 6, GPIO_PIN_6,
		GPIOC, "PC7", "C", 7, GPIO_PIN_7, GPIOC, "PC13", "C", 13, GPIO_PIN_13, GPIOC, "PD0", "D", 0, GPIO_PIN_0, GPIOD, "PD1", "D", 1, GPIO_PIN_1, GPIOD, "PD3", "D", 3, GPIO_PIN_3, GPIOD, "PD4", "D", 4, GPIO_PIN_4, GPIOD, "PD5", "D", 5, GPIO_PIN_5, GPIOD, "PD6", "D", 6, GPIO_PIN_6, GPIOD, "PD7",
		"D", 7, GPIO_PIN_7, GPIOD, "PD8", "D", 8, GPIO_PIN_8, GPIOD, "PD9", "D", 9, GPIO_PIN_9, GPIOD, "PD10", "D", 10, GPIO_PIN_10, GPIOD, "PD11", "D", 11, GPIO_PIN_11, GPIOD, "PD12", "D", 12, GPIO_PIN_12, GPIOD, "PD13", "D", 13, GPIO_PIN_13, GPIOD, "PD14", "D", 14, GPIO_PIN_14, GPIOD, "PD15", "D",
		15, GPIO_PIN_15, GPIOD, "PE0", "E", 0, GPIO_PIN_0, GPIOE, "PE1", "E", 1, GPIO_PIN_1, GPIOE, "PE2", "E", 2, GPIO_PIN_2, GPIOE, "PE3", "E", 3, GPIO_PIN_3, GPIOE, "PE4", "E", 4, GPIO_PIN_4, GPIOE, "PE5", "E", 5, GPIO_PIN_5, GPIOE, "PE6", "E", 6, GPIO_PIN_6, GPIOE, "PE7", "E", 7, GPIO_PIN_7,
		GPIOE, "PE8", "E", 8, GPIO_PIN_8, GPIOE, "PE9", "E", 9, GPIO_PIN_9, GPIOE, "PE10", "E", 10, GPIO_PIN_10, GPIOE, "PE11", "E", 11, GPIO_PIN_11, GPIOE, "PE12", "E", 12, GPIO_PIN_12, GPIOE, "PE13", "E", 13, GPIO_PIN_13, GPIOE, "PE14", "E", 14, GPIO_PIN_14, GPIOE, "PE15", "E", 15, GPIO_PIN_15,
		GPIOE };
...
struct table T[58]; // Укажи количество строк начало с 1
int tabline = 57;   // Укажи количество строк начало с 0
