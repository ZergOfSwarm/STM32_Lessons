...
/* USER CODE BEGIN PD */
	char str[50] = {0};
	uint16_t t;
	const uint8_t TEXT_Buffer[]={"QSPI, read and write test!"};
	const uint8_t TEXT_Buffer2[]={"Zerg of Swarm!"};
...
uint32_t i=0;
uint16_t count =0;
/********************* Пример сохранения чисел ***************************/
uint16_t number = 12345;
uint8_t buf[6]; // Создадим буфер для числа.
/* USER CODE END 0 */
