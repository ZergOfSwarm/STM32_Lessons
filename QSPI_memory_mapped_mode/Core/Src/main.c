...
/* USER CODE BEGIN PD */
	char str[50] = {0};
		uint16_t t;
	const uint8_t TEXT_Buffer[]={"Hello world from QSPI, MEMORY MAPPED MODE!"};
	const uint8_t TEXT_Buffer2[]={"VARSA SEKLINIZ CIKISA BEKLERIZ :D ."};
...
int main(void)
{
  ...
  //memcpy(TEXT_Buffer,(uint8_t*) 0x90000000, 40);
