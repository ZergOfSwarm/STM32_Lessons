...
/* Internal reference voltage (STM32F103C8T6 datasheet 5.3.4,
   Table 12 "Embedded internal reference voltage") */
#define VREFINT 1200.0f // V REFINT (Typ) = 1.200 V (Умножил на 1000 для более точных расчетов.)

uint16_t SMA_Filter_Buffer_1[SMA_FILTER_ORDER] = { 0, };
uint16_t SMA_Filter_Buffer_2[SMA_FILTER_ORDER] = { 0, };

uint16_t ADC_RAW_Data[2] = { 0, }; // Сырые значения, получаем на скорости 100kHz
uint16_t ADC_SMA_Data[2] = { 0, }; // Отфильтрованные знаения, получаем на скорости 100kHz!
...
/* External variables --------------------------------------------------------*/
extern ADC_HandleTypeDef hadc1; // Я добавил из main.c CubeIDE почему-то этого не проделал сам!
